<?php
/**
 * Consignments Module - AI Insights
 *
...
<div class="page-header fade-in mb-4">
    <h1 class="page-title mb-2"><i class="bi bi-lightbulb me-2"></i>AI Insights</h1>
    <p class="page-subtitle text-muted mb-0">Intelligent recommendations and predictions</p>
</div>
