...
$theme->setTitle('Transfer Manager');
$theme->setPageSubtitle('Ad-hoc consignment management tool');
$theme->addBreadcrumb('Consignments', '/modules/consignments/');
$theme->addBreadcrumb('Transfer Manager', null);
...
<!-- Transfer Manager Assets -->
<link rel="stylesheet" href="/modules/consignments/assets/css/tokens.css?v=<?= time() ?>">
<link rel="stylesheet" href="/modules/consignments/assets/css/transfer-manager-v2.css?v=<?= time() ?>">
