...
define('DB_USERNAME', 'jcepnzzkmj');
define('DB_PASSWORD', 'wprKh9Jq63');
define('DB_DATABASE', 'jcepnzzkmj');

// Simple database connection helper
function db_ro(): PDO {
    static $pdo = null;
    if ($pdo === null) {
        $dsn = sprintf('mysql:host=%s;dbname=%s;charset=utf8mb4', DB_HOST, DB_DATABASE);
